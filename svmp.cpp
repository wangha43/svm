...
int main()
{
	...
	//依次读取正样本图片，生成HOG描述子  
        ...
        {  
            ...
            ImgName = "C:\\QMDownload\\INRIAPerson\\96X160H96\\Train\\pos\\" + ImgName;//加上正样本的路径名  
		...
		{  
			svm.load("C:\\Users\\wxc\\Documents\\Visual Studio 2010\\Projects\\svmp\\svmp\\SVM_HOG.xml");//从XML文件读取训练好的SVM模型  
		}  
