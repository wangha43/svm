...
void load_images( const string & prefix, const string & filename, vector< string > & img_lst );
void sample_neg( const vector< Mat > & full_neg_lst, vector< Mat > & neg_lst, const Size & size );
Mat get_hogdescriptor_visu(const Mat& color_origImg, vector<float>& descriptorValues, const Size & size );
void compute_hog( const vector< string > & img_lst, vector< Mat > & gradient_lst, const Size & size );
...
//    }
//    vector< Mat > pos_lst;
    vector <string>pos_lst;
//    vector< Mat > full_neg_lst;
//    vector< Mat > neg_lst;
    vector< string > neg_lst;
